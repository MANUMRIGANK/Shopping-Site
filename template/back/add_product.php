<div class="col-md-12">
  ...
  <form action="../../template/back/add_product_func.php" method="post" enctype="multipart/form-data">
    ...
    <aside id="admin_sidebar" class="col-md-4">
      ...
      <div class="form-group">
        <input type="submit" name="action" class="btn btn-warning btn-lg" value="Draft">
        <input type="submit" name="action" class="btn btn-primary btn-lg" value="Publish">
      </div>
